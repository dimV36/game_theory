...
class GthMethods:
    ...
    def get_nash_equilibrium_mixed_strategy_2x2(bi_matrix):
        f_matrix = array(bi_matrix.first)
        s_matrix = array(bi_matrix.second)
        ...
        first_strategy = array([[1 - f_prob, f_prob]])
        second_strategy = array([[1 - s_prob], [s_prob]])
        first = dot(dot(first_strategy, bi_matrix.first), second_strategy)
        second = dot(dot(first_strategy, bi_matrix.second), second_strategy)
        return [BiMatrix(first.round(3), second.round(3))]